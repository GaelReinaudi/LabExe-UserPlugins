...
#include "ui_GSerialPortControllerWidget.h"
#include <stdio.h>
#include <QMutexLocker>
//#include "hled.h"


GSerialPortControllerWidget::GSerialPortControllerWidget(GSerialPortController* pTheController, QWidget *parent)
	: QWidget(parent)
	, m_pController(pTheController)
{
	ui = new Ui::GSerialPortControllerWidget();
	led = new HLed(this);
...
GSerialPortControllerWidget::~GSerialPortControllerWidget()
{
	delete ui;
}

void GSerialPortControllerWidget::ConnectedLED()
{
	led->setColor(Qt::green);
	led->turnOn();
}

void GSerialPortControllerWidget::DisconnectedLED()
{
	led->setColor(Qt::red);
	led->blink();
}
...
void GSerialPortControllerWidget::WidgetClearCursor()
{
