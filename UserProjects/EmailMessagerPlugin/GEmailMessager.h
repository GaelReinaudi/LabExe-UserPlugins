#ifndef GEmailMessager_H
#define GEmailMessager_H

#include "device.h"
#include "param.h"
/////////////////////////////////////////////////////////////////////
//! \brief The GEmailMessager class implements a GProgDevice.
/*!
...
*/
//[inheritance]
class GEmailMessager : public GProgDevice
//[inheritance]
{
	Q_OBJECT
...
//[constructor]
	//! Constructor
	GEmailMessager(QObject *parent, QString uniqueIdentifierName = "");
//[constructor]
	~GEmailMessager();
...
protected:
	//! Re-implemented to provide a new widget adequately connected to this GEmailMessager.
