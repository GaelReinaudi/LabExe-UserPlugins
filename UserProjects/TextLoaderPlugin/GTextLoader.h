#ifndef GTextLoader_H
#define GTextLoader_H

#include "device.h"
#include "param.h"
/////////////////////////////////////////////////////////////////////
//! \brief The GTextLoader class implements a GProgDevice.
/*!
...
*/
//[inheritance]
class GTextLoader : public GProgDevice
//[inheritance]
{
	Q_OBJECT
...
//[constructor]
	//! Constructor
	GTextLoader(QObject *parent, QString uniqueIdentifierName = "");
//[constructor]
	~GTextLoader();
...
protected:
	//! Re-implemented to provide a new widget adequately connected to this GTextLoader.
