...
{
 	QWidget* pWid = new GNovatech409BWidget(this, theDeviceWidget);
...
void GNovatech409B::setNewParity()
{
...
void GNovatech409B::setNewDataBits()
{
...
void GNovatech409B::setNewStopBits()
{
...
void GNovatech409B::ShowPortSettings()
{
...
void GNovatech409B::ReadCurrentSettings(QByteArray settings)
{
...
void GNovatech409B::SetPortName(QString portName)
{
	m_PortName = portName;
...
void GNovatech409B::SetNovaTechFreq0(double freq0)
{
	emit LEDisRed();
	QString qFreq0;
...
void GNovatech409B::SetNovaTechFreq1(double freq1)
{
	emit LEDisRed();
	QString qFreq1;
...
void GNovatech409B::SetNovaTechFreq2(double freq2)
{
	emit LEDisRed();
	QString qFreq2;
...
void GNovatech409B::SetNovaTechFreq3(double freq3)
{
	emit LEDisRed();
	QString qFreq3;
...
QString GNovatech409B::ReturnPortName()
{
	return m_SetComPort.StringValue();
}


//void GNovatech409B::OnDataAvailable() 
//{
...
void GNovatech409B::onReadyRead()
{
	emit LEDisGreen();
	QByteArray bytes;
	int QLocation = -1;
...
void GNovatech409B::onDsrChanged(bool status)
{
	if(status)
		qDebug() << "Novatech 409B was turned on";
	else
		qDebug() << "Novatech 409B was turned off";
}

QStringList GNovatech409B::PortList()
{
...
//void GNovatech409B::ConnectToPort()
//{
//	qDebug() << "GNovatech409B::ConnectToPort";
//}

//void GNovatech409B::WriteToNovaTech()
//{
