...
GTextLoader::GTextLoader(QObject *parent, QString uniqueIdentifierName /* = "" */)
...
/////////////////////////////////////////////////////////////////////
/*!
Populates a widget provided by a workbench in order to represent (and be adequately connected to) this GTextLoader. 
...
void GTextLoader::PopulateDeviceWidget(GDeviceWidget* theDeviceWidget )
{
...
void GTextLoader::EventSampleArrived(double newValue)
{
