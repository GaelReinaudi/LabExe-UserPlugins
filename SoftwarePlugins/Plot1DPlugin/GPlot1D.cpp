...
GPlot1D::GPlot1D(QObject *parent, QString uniqueIdentifierName /* = "" */)
...
/////////////////////////////////////////////////////////////////////
/*!
Populates a widget provided by a workbench in order to represent (and be adequately connected to) this GPlot1D. 
...
void GPlot1D::PopulateDeviceWidget(GDeviceWidget* theDeviceWidget )
{
...
void GPlot1D::InitSavedSettings()
...
void GPlot1D::EventNewValueY(double newValueY)
{	
