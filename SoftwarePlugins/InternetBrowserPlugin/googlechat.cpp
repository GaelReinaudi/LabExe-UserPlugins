...
#define GOOGLECHAT_URL "https://mail.google.com/mail/mu"
//#define GOOGLECHAT_URL "https://docs.google.com/presentation/pub?id=1pmz1D33S-ki1xbaq8wavwPEd8YCU9SaXHWaJwDdKYuE&start=false&loop=false&delayms=3000"
	...
	: QWidget() 
{
    ...
    connect(form.webView, SIGNAL(loadProgress(int)), form.progressBar, SLOT(setValue(int)));
