...
GEmailMessager::GEmailMessager(QObject *parent, QString uniqueIdentifierName /* = "" */)
...
/////////////////////////////////////////////////////////////////////
/*!
Populates a widget provided by a workbench in order to represent (and be adequately connected to) this GEmailMessager. 
...
void GEmailMessager::PopulateDeviceWidget(GDeviceWidget* theDeviceWidget )
{
...
void GEmailMessager::EventSampleArrived(double newValue)
{
...
void GEmailMessager::UpdateOutput()
{
