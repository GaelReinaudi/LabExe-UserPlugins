...
//	void __stdcall           CallbackProcEx(long Ver, long Mode, long IntVal, 
//	                                        double DblVal, long Res1) ;
	...
	Data_API(long)           ControlWLM(long Action, long App, long Ver) ;
	Data_API(long)           ControlWLMEx(long Action, long App, long Ver, long Delay, long Res) ;
...
// WLM Control Mode Constants
	const int	cCtrlWLMShow = 0x01;
	const int	cCtrlWLMHide = 0x02;
	const int	cCtrlWLMExit = 0x03;
	const int	cCtrlWLMWait = 0x10;
	const int	cCtrlWLMStartSilent = 0x20;
	const int	cCtrlWLMSilent = 0x40;

// Operation Mode Constants (for "Operation" and "GetOperationState" functions)
	const int	cStop = 0x00;
	const int	cAdjustment = 0x01;
	const int	cMeasurement = 0x02;
...
// but still can be combined with "Measurement Action Addition Constants". See below.)
	...
	const int	cCtrlStartRecord = 0x04;
	const int	cCtrlStartReplay = 0x08;
	const int	cCtrlStoreArray = 0x10;
	const int	cCtrlLoadArray = 0x20;
...
// Return flags of ControlWLMEx in combination with Show or Hide, Wait and Res = 1
	const int	flServerStarted = 0x01;
	const int	flErrDeviceNotFound = 0x02;
	const int	flErrDriverError = 0x04;
	const int	flErrUSBError = 0x08;
	const int	flErrUnknownDeviceError = 0x10;
	const int	flErrWrongSN = 0x20;
	const int	flErrUnknownSN = 0x40;
	const int	flErrTemperatureError = 0x80;
